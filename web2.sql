...
CREATE TABLE korlatozas (
    ...
    mettol DATE,
    meddig DATE,
    megnevid VARCHAR(255),
    mertekid INT,
    sebesseg INT
);

ALTER TABLE `korlatozas` ADD INDEX(`megnevid`, `mertekid`);
...
(86, 2.381, 5.39, 'Rédics', '2010-04-19', '2010-08-01', '7', 3, 40),
(86, 94.5, 98.6, 'Szeleste', '2010-09-08', '2010-11-30', '4', 1, 40),
(86, 19.5, 21.86, 'Kálócfa - Kozmadombja', '2010-04-19', '2010-08-31', '4', 3, 30),
(86, 159.95, 160.1, 'Bősárkány', '2010-04-26', '2010-06-30', '4', 3, 30),
(451, 25.135, 27.05, 'Csongrád', '2010-03-22', '2010-08-27', '2', 1, 40),
(471, 71, 72.15, 'Mátészalka', '2010-03-30', '2010-06-30', '4', 1, 30),
(471, 27.5, 28.8, 'Nyíradony', '2010-04-01', '2010-06-30', '10', 1, 30),
(1109, 6.65, 6.69, 'Csobánka', '2010-05-24', '2010-06-21', '4', 1, 30),
(1111, 26.2, 26.7, 'Esztergom', '2010-06-04', '2010-06-18', '10', 3, 30),
(1119, 27.97, 29.456, 'Tarján', '2010-05-13', '2010-06-15', '7', 3, 40),
(1406, 1.25, 2.86, 'Mosonmagyaróvár - Máriakálnok', '2010-06-03', '2010-07-15', '4', 1, 50),
(2105, 13, 14.386, 'Galgamácsa', '2010-05-16', '2010-06-30', '6', 4, NULL),
(2105, 13, 14.386, 'Galgamácsa', '2010-06-01', '2010-06-30', '6', 4, NULL),
(2109, 18.97, 19.85, 'Palotás', '2010-05-17', '2010-06-15', '4', 3, 30),
(2119, 4.865, 11.725, 'Balassagyarmat - Csitár', '2010-05-03', '2010-06-15', '4', 3, 40),
(2124, 9.615, 12.5, 'Cserháthaláp - Szanda', '2010-05-03', '2010-06-15', '4', 3, 40),
(2126, 2.1, 2.2, 'Ecseg', '2010-05-03', '2010-06-15', '4', 3, 40),
(2127, 2.55, 4.3, 'Csécse', '2010-05-03', '2010-06-15', '4', 3, 40),
(2206, 8.985, 10.472, 'Karancskeszi', '2010-04-06', '2010-06-30', '4', 1, 30),
(2301, 0, 2.6, 'Bátonyterenye - Rákóczibánya', '2010-05-03', '2010-06-15', '4', 3, 40),
(2302, 7.3, 7.5, 'Kazár', '2010-05-03', '2010-06-15', '4', 3, 30),
(2504, 0.35, 0.95, 'Eger', '2010-05-03', '2010-08-02', '10', 4, NULL),
(2504, 0.95, 1.72, 'Eger', '2010-05-03', '2010-08-02', '10', 1, 30),
(2505, 52.083, 53.023, 'Miskolc', '2010-05-31', '2010-06-30', '9', 3, 30),
(2505, 53.57, 58.5, 'Miskolc', '2010-05-31', '2010-06-30', '3', 3, 30),
(2507, 4.3, 4.35, 'Borsodnádasd', '2010-06-01', '2010-10-31', '10', 3, 30),
(2507, 3.9, 4.3, 'Borsodnádasd', '2010-06-01', '2010-07-31', '6', 3, 30),
(2519, 1.511, 3.632, 'Miskolc', '2010-05-31', '2010-06-30', '4', 3, 30),
(3216, 28, 28.5, 'Tiszabura - Tiszaroff', '2010-06-04', '2010-06-30', '6', 4, NULL),
(4422, 39.5, 39.101, 'Makó', '2010-07-24', '2010-08-31', '4', 2, 30),
(4516, 16.9, 16.165, 'Szentes', '2010-02-22', '2010-08-31', '4', 1, 30),
(4516, 16.145, 16.149, 'Szentes', '2010-05-28', '2010-06-15', '4', 1, 30),
(4517, 2.06, 2.06, 'Csongrád', '2010-03-22', '2010-08-27', '2', 1, 40),
(4519, 1.003, 1.003, 'Csongrád', '2010-03-22', '2010-08-27', '2', 1, 40),
(4609, 23.5, 24, 'Jászkarajenő', '2010-06-03', '2010-06-30', '6', 1, 40),
(4612, 0, 0.775, 'Abony', '2010-06-03', '2010-06-30', '7', 1, 30),
(4911, 0.777, 2, 'Nyíregyháza', '2010-03-16', '2010-10-30', '5', 1, 30),
(4918, 0, 3, 'Mátészalka - Nyírcsaholy', '2010-03-30', '2010-06-30', '4', 1, 30),
(5113, 5.775, 11.39, 'Őcsény - Decs', '2010-05-06', '2010-06-15', '7', 3, 30),
(5113, 11.39, 13.415, 'Decs', '2010-04-28', '2010-07-15', '6', 4, 30),
(5204, 0, 9.855, 'Bugyi - Kiskunlacháza', '2010-03-16', '2010-07-17', '4', 4, 30),
(5701, 0, 4.67, 'Bóly - Szederkény', '2010-03-01', '2010-08-31', '4', 4, NULL),
(5711, 4, 4.85, 'Kozármisleny', '2010-08-01', '2010-08-31', '4', 4, 30),
(6231, 0.175, 0.224, 'Paks', '2010-03-16', '2010-06-15', '4', 2, 30),
(6316, 2.61, 3.1, 'Medina', '2010-04-21', '2010-07-09', '7', 1, 40),
(6535, 16.082, 16.115, 'Tevel', '2010-06-03', '2010-06-25', '10', 3, 30),
(6541, 19.45, 19.6, 'Magyaregregy', '2010-04-09', '2010-08-31', '11', 3, 30),
(7306, 0, 2.195, 'Ajka', '2010-07-06', '2010-07-30', '4', 1, 30),
(7417, 0.65, 2.711, 'Kerkafalva', '2010-02-01', '2010-12-31', '10', 6, 30),
(7522, 19.5, 21.3, 'Esztergályhorváti', '2010-05-31', '2010-06-30', '10', 3, 40),
...
(8102, 17.5, 18.403, 'Budakeszi', '2010-04-12', '2010-06-30', '10', 1, 30),
(8113, 7.902, 11.595, 'Szárliget', '2010-05-13', '2010-06-15', '7', 3, 40),
(8116, 9.864, 15.697, 'Pákozd - Sukoró', '2010-03-16', '2010-06-30', '11', 1, 30),
(8127, 26, 26.4, 'Dad - Kocs', '2010-01-26', '2010-06-30', '10', 5, NULL),
(8135, 20.98, 21.04, 'Dad - Császár', '2010-05-31', '2010-06-18', '6', 3, 40),
